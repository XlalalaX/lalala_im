...
import (
	...
	"lalala_im/servers/receive_server/internal/conf"
	"lalala_im/servers/receive_server/internal/http/route"
	"net/http"
	"os"
	"os/signal"
	"syscall"
...
func main() {
	...
	server := &http.Server{
		Addr:    fmt.Sprintf(":%d", conf.Bootstrap.Server.Port),
		Handler: router,
	}
