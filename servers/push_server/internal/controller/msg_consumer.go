...
import (
	...
	"lalala_im/servers/push_server/internal/db"
)
...
type MsgConsumer struct {
	//MaxConn int
	//ConnMap map[string]pb_msg.MsgServerClient //太难控制空间大小
	//*sync.RWMutex
}
...
//
//func (m *MsgConsumer) GetClient(addr string) pb_msg.MsgServerClient {
//	m.RLock()
...
//}
//
//func (m *MsgConsumer) DelClient(addr string) {
//	m.Lock()
...
func NewMsgConsumer() sarama.ConsumerGroupHandler {
	return &MsgConsumer{
		//ConnMap: map[string]pb_msg.MsgServerClient{},
