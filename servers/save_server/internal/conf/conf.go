...
func init() {
	err := cleanenv.ReadConfig("D:\\Goland\\go_xm\\lalala_im\\configs\\save_server_conf.yml", Bootstrap)
	if err != nil {
		panic(err)
	}
	...
	db.InitDB(Bootstrap.Data.Redis.ADDR, Bootstrap.Data.Redis.Password, Bootstrap.Kafka.Addr, Bootstrap.Kafka.ConsumerGroup, Bootstrap.Data.Mongo.Url, Bootstrap.Data.Mongo.Database)
