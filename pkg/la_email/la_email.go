...
func InitEmail(senderStr, nameStr, passStr, hostStr string, portInt int) {
	sender = senderStr
	name = nameStr
	pass = passStr
	host = hostStr
...
func SendMail(mailTo []string, subject string, body string) error {
	...
	m.SetHeader("From", m.FormatAddress(sender, name)) // 添加别名
	...
	*/
	d := gomail.NewDialer(host, port, sender, pass) // 设置邮件正文
